    ...
    <div class="container">
        ...
        @method('patch')
            ...
            <div class="row mb-3 form-group">
                ...
                <div class="col-md-6">
                    <textarea id="detail" rows="10" maxlength="500" class="form-control @error('detail') is-invalid @enderror" name="detail" autocomplete="detail" required>{{ old('detail', $item->detail) }}</textarea>
